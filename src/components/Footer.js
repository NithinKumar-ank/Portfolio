        ...
        <div className="footer-container">
         ...
         nithinthecoder@gmail.com
            ...
            <div className="right">
               ...
               <p>I am a passionate React developer with a love for creating interactive and user-friendly web applications.</p>
              <div className="social">

               {/* <a href="https://www.facebook.com/siva.jaya.180?mibextid=ZbWKwL" >
              <FaFacebook size={30} style={{color:"white",marginRight:"1rem"}}/></a> */}
               <a href="https://github.com/NithinKumar-ank/NithinKumar-ank/blob/main/ABOUTME.md">
                  <FaGithub size={30} style={{color:"white",marginRight:"1rem"}}/>
               </a>
           
              <a href=" https://twitter.com/NithinKumar_ank"><FaTwitter size={30} style={{color:"white",marginRight:"1rem"}}/></a>

              <a href="https://www.linkedin.com/in/nithinkumar-ank"><FaLinkedin size={30} style={{color:"white",marginRight:"1rem"}}/></a>
